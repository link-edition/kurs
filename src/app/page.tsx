        ...
        <div className="grid grid-cols-1 md:grid-cols-12 grid-rows-2 gap-6 h-auto md:h-[800px] relative z-10">
          ...
          <div className="md:col-span-8 md:row-span-1 glass-card rounded-xl p-10 relative overflow-hidden kinetic-tilt transition-all duration-500 shadow-[0_40px_80px_rgba(0,0,0,0.4)] group">
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                ...
                <p className="text-[#ababab] max-w-sm text-lg">
                  {lang === 'uz' 
              ...
              <div className="mt-12 flex gap-4">
                <span className="px-4 py-2 rounded-full bg-[#1f1f1f] text-xs font-bold text-[#f3ffca] border border-white/5 uppercase tracking-wider">{lang === 'uz' ? 'Modullar' : 'Modules'}</span>
                <span className="px-4 py-2 rounded-full bg-[#1f1f1f] text-xs font-bold text-[#f3ffca] border border-white/5 uppercase tracking-wider">{lang === 'uz' ? 'Darslar' : 'Lessons'}</span>
              </div>
            </div>
          ...
          <div className="md:col-span-4 md:row-span-2 glass-card rounded-xl p-10 relative overflow-hidden kinetic-tilt transition-all duration-500 shadow-[0_40px_80px_rgba(0,0,0,0.4)] group border-l border-[#fedc00]/20">
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <p className="text-[#ababab] text-lg mb-12">
                {lang === 'uz' 
              ...
              <div className="mt-auto space-y-4">
                <div className="bg-black/40 p-4 rounded-xl border border-white/5">
                  <div className="text-xs text-[#ababab] mb-1">{lang === 'uz' ? 'Faol o\'quvchilar' : 'Active Students'}</div>
          ...
          {/* Video Integration */}
          <div className="md:col-span-8 md:row-span-1 glass-card rounded-xl p-10 relative overflow-hidden kinetic-tilt transition-all duration-500 shadow-[0_40px_80px_rgba(0,0,0,0.4)] group border-t border-[#00ffcc]/10">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="w-full md:w-64 aspect-video rounded-xl bg-black/60 border border-white/10 flex items-center justify-center group-hover:border-[#00ffcc]/40 transition-colors">
                <span className="material-symbols-outlined text-4xl text-white/20 group-hover:text-[#00ffcc] transition-colors">brand_awareness</span>
              </div>
            </div>
          </div>
        </div>
