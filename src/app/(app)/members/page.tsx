...
export default function MembersPage() {
  const members = [
    { id: 1, name: "Admin", email: "admin@coursearchitect.io", role: "Owner", status: "Active", joined: "2026-01-15" },
  ];

  return (
    <div className="p-12 space-y-12 max-w-[1400px] w-full mx-auto relative z-10">
      <header className="space-y-4">
        <h1 className="text-5xl font-bold text-white font-headline tracking-tighter">Members</h1>
        <p className="text-[#919191] text-lg max-w-2xl font-light">
          Manage team members, instructors, and student access.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#262626]/40 backdrop-blur-xl border border-white/5 p-6 rounded-2xl">
          <p className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#cafd00]/50 mb-1">Total Members</p>
          <h3 className="text-3xl font-bold text-white">{members.length}</h3>
        </div>
        <div className="bg-[#262626]/40 backdrop-blur-xl border border-white/5 p-6 rounded-2xl">
          <p className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#cafd00]/50 mb-1">Active Now</p>
          <h3 className="text-3xl font-bold text-white">1</h3>
        </div>
        <div className="bg-[#262626]/40 backdrop-blur-xl border border-white/5 p-6 rounded-2xl">
          <p className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#cafd00]/50 mb-1">Invitations Sent</p>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <h4 className="text-xl font-bold tracking-tight text-white font-headline">Team Members</h4>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#cafd00]/5">
                <th className="px-6 py-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#fedc00]">Name</th>
                <th className="px-6 py-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#fedc00]">Email</th>
                <th className="px-6 py-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#fedc00]">Role</th>
                <th className="px-6 py-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#fedc00]">Status</th>
                <th className="px-6 py-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#fedc00] text-right">Joined</th>
              </tr>
            </thead>
      ...
      <section className="bg-[#111] border border-dashed border-white/5 rounded-2xl p-8 text-center max-w-2xl mx-auto">
        ...
        <h3 className="text-lg font-bold text-white mb-2">Authentication Coming Soon</h3>
        <p className="text-sm text-[#666] leading-relaxed">Team member management will be fully functional once authentication (Clerk/NextAuth) is integrated. For now, this page shows your admin account.</p>
      </section>
    </div>
  );
}
